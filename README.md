...
```
	   测试输出如下：
	   	   [命令：]
	   	   ![image](https://github.com/pxx199181/tiny_linux/result-pic/normal-cmd.png)
	   	   [结果：]
	   	   ![image](https://github.com/pxx199181/tiny_linux/result-pic/normal-result.png)
	   	   [命令：]
	   	   ![image](https://github.com/pxx199181/tiny_linux/result-pic/kernelmode-cmd.png)
	   	   [结果：]
	   	   ![image](https://github.com/pxx199181/tiny_linux/result-pic/kernelmode-result.png)
